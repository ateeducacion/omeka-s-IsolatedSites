...
Read [site-isolation](.agents/skills/site-isolation/SKILL.md) when you need to: change admin/API resource filtering, site membership assertions, or write permissions.
